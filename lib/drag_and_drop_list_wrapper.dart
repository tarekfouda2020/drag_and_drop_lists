...
import 'package:drag_and_drop_lists/load_more_refresh_widget/loadmore_refresher_widget.dart';
...
class DragAndDropListWrapper extends StatefulWidget {
  ...
  DragAndDropListWrapper({required this.dragAndDropList, required this.parameters, Key? key})
      : super(key: key);
    ...
    if (widget.parameters.axis == Axis.horizontal && !widget.parameters.disableScrolling) {
      toReturn = SizedBox(
        ...
        child: LoadMoreRefresher(
          ...
          footer: widget.dragAndDropList.footer,
          header: widget.dragAndDropList.header,
          noMoreDataString: widget.dragAndDropList.noMoreDataString ?? "no more",
          refreshController: widget.dragAndDropList.refreshController,
          onLoadMore: widget.dragAndDropList.onLoadMore,
